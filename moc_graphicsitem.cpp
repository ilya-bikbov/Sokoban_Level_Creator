...
static const char qt_meta_stringdata_GraphicsItem[] = {
    "GraphicsItem\0\0item_num\0slot_set_pixmap(int)\0"
};
...
void GraphicsItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->slot_set_pixmap((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
const QMetaObject GraphicsItem::staticMetaObject = {
    { &QGraphicsObject::staticMetaObject, qt_meta_stringdata_GraphicsItem,
